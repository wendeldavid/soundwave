 ...
 * Esta classe implementa métodos para detectar colisão, espelhá-la, move-la, 
...
public class Figura implements RayTracing, MirrorModel, TranslateModel,
    ...
    /**
     * Vetor que contém as sete peças (Peca)
     */
    Peca[] pecas;
    ...
    /**
     * Retorna um objeto de Apontamento se houve intersecção da Linha ray com alguma
     * das peças da figura.
     * @param ray
     * @return
     */
    ...
    /**
     * Retorna dentre todos os pontos das peças da figura o mais próximo da
     * Linha ray
     * @param ray
     * @return
     */
    ...
    /**
     * Desenha todas as peças que estão visiveis na tela.
     * @param gl
     */
     ...
     * @param origem Vetor3f que representa o ponto centro de rotação
     */
    ...
    /**
     * Este método compara todas as cores das peças da figura.
    ...
    /**
     * Atribui uma peça pelo número dela.
     * @param p
     * @param num
     * @return
     */
